        ...
        <ModuleHeader>
            ...
            <template v-slot:desc>
                <v-alert                                        
                    ...
                    type="info"
                    >
                     User dengan role PSB bertanggungjawab terhadap proses penerimaan mahasiswa baru.
                </v-alert>
            </template>
        </ModuleHeader> 
        <v-container fluid> 
                    ...
                    >
                        <template v-slot:top>
                            <v-toolbar flat color="white">
                                <v-toolbar-title>DAFTAR USERS PSB</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical
                                ...
                                <v-btn color="primary"                           
                                    ...
                                    :loading="btnLoading"
                                    :disabled="btnLoading"
                                    @click.stop="showDialogTambahUserPSB">
                                    TAMBAH
                                </v-btn>
                                <v-dialog v-model="dialog" max-width="500px" persistent>
                                    <v-form ref="frmdata" v-model="form_valid" lazy-validation>
                                        <v-card>
                                            ...
                                            <v-card-subtitle>
                                                Bila program studi, tidak dipilih artinya user ini dapat mengakses seluruh data psb.
                                            </v-card-subtitle>
                                            <v-card-text>
                                                <v-text-field 
                                                ...
                                                <v-autocomplete 
                                                    ...
                                                    v-model="editedItem.kode_jenjang"
                                                    label="JENJANG STUDI" 
                                                    item-text="text"
                                                    item-value="id"
                                                    multiple 
    ...
    methods: {
        ...
        deleteItem(item) {
            this.$root.$confirm.open('Delete', 'Apakah Anda ingin menghapus username '+item.username+' ?', { color: 'red' }).then((confirm) => {
                ...
                {
                    this.btnLoading = true;
                    this.$ajax.post('/system/userspsb/'+item.id,
                        {
                            '_method': 'DELETE',
                        },
                        {
