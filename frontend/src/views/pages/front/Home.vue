      ...
      <v-row dense justify="center" align="center">
        <v-col xs="12" sm="6" md="3" v-if="registerTK">
          <v-card color="#099773" dark>
            ...
            <v-card-actions>
              <v-btn color="info" block to="/psbtk">
                DAFTAR
              </v-btn>
            </v-card-actions>
          </v-card>
                ...
                <v-timeline-item small color="green">
                  ...
                  <div class="py-4">
                    ...
                    <div>
                      ...
                      <ol type="a">
                        <li>Ananda sudah berusia min. <strong>4.5 tahun</strong> maks. <strong>6 Tahun</strong> pada 31 Juli {{ 2024 }}. <strong>untuk Jenjang Studi TK</strong></li>
