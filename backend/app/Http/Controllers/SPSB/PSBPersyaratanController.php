...
class PSBPersyaratanController extends Controller {         
    /**
     * digunakan untuk mendapatkan calon calon peserta didik baru yang baru mendaftar di halaman pendaftaran
     *
    ...
    public function update(Request $request,$id)
    {
        ...
        else
        {
            ...
            $data_siswa = \DB::transaction(function () use ($request,$formulir){                            
                $formulir->nama_siswa=$request->input('nama_siswa');
                ...
                $formulir->address1_rt=$request->input('address1_rt');
                $formulir->address1_rw=$request->input('address1_rw');
                $formulir->kode_pos=$request->input('kode_pos');
                $formulir->kewarganegaraan=$request->input('kewarganegaraan');
                
                $formulir->asal_sekolah=$request->input('asal_sekolah');
                ...
                $formulir->avoid_food=$request->input('avoid_food');
    ...
    public function updatebiodataayah(Request $request,$id)
    {
        ...
        else
        {
            ...
            $data_siswa = \DB::transaction(function () use ($request,$formulir){                            
                ...
                $formulir->pendidikan=$request->input('pendidikan');
