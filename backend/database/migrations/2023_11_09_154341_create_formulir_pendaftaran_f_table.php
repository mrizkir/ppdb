...
class CreateFormulirPendaftaranFTable extends Migration
{
  /**
   * Run the migrations.
   *
  ...
  public function up()
  {
    ...
    Schema::create('formulir_pendaftaran_f', function (Blueprint $table) {
  ...
  {
    Schema::dropIfExists('formulir_pendaftaran_f');
  }
}
